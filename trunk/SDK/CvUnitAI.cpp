...
/*************************************************************************************************/
		if (area()->getAreaAIType(getTeam()) == AREAAI_OFFENSIVE)
		{
			...
			{
				//if (AI_targetCity())
				if (AI_targetCity(MOVE_AVOID_ENEMY_WEIGHT_2, 12))
				{
					return;
				}
			}
...
/*************************************************************************************************/
	// Rearranged so attack stacks will more readily attack nearby enemy units
...
/*************************************************************************************************/
		if( isBarbarian() )
		{
			if (AI_targetCity(MOVE_AVOID_ENEMY_WEIGHT_2, 9))
			{
				return;
			}
		}
		else if (bHuntBarbs && AI_targetBarbCity((bAnyWarPlan ? 7 : 12)))
/*************************************************************************************************/
/** BETTER_BTS_AI_MOD                       END                                                  */
/*************************************************************************************************/
		{
...
/********************************************************************************/
	...
	*/
	...
	// TODO: Support friendly attacks on common enemies, if low risk?
...
/********************************************************************************/
	...
	*/
	...
	// TODO: how valuable is recon information to AI in war time?	
	if (canRecon(plot()))
	{
...
/********************************************************************************/
	...
	if (isCargo())
	{
		// BBAI TODO: 3.19 changed this from 1 in 5 to 2 in 3 ... good?
...
*/
	// Removed blanket block on loading in land war, now handled by specific unit AI logic
/*************************************************************************************************/
/** BETTER_BTS_AI_MOD                       END                                                  */
/*************************************************************************************************/
...
/*************************************************************************************************/
// Returns true if a mission was pushed...
bool CvUnitAI::AI_targetCity(int iFlags, int iMaxPathTurns )
{
	PROFILE_FUNC();
...
// Returns true if a mission was pushed...
bool CvUnitAI::AI_targetBarbCity(int iMaxPathTurns)
{
	PROFILE_FUNC();
...
bool CvUnitAI::AI_pickupStranded(UnitAITypes eUnitAI, int iMaxPath)
{
	...
	for(pLoopGroup = kPlayer.firstSelectionGroup(&iLoop); pLoopGroup != NULL; pLoopGroup = kPlayer.nextSelectionGroup(&iLoop))
	{
		if( pLoopGroup->isStranded() )
		{
			...
			if ( atPlot(pLoopPlot) || GET_PLAYER(getOwnerINLINE()).AI_unitTargetMissionAIs(pHeadUnit, MISSIONAI_PICKUP, getGroup()) < ((iCount + (cargoSpace() - 1)) / cargoSpace()))
			{
				pPickupPlot = NULL;
				if( atPlot(pLoopPlot) || generatePath(pLoopPlot, 0, true, &iPathTurns) )
				{
