...
int CvPlayerAI::AI_movementPriority(CvSelectionGroup* pGroup) const
{
	...
	/********************************************************************************/
	/**		BETTER_BTS_AI_MOD						10/21/08		jdog5000		*/
	/**																				*/
	/**		Air AI																	*/
	/********************************************************************************/
	/* original BTS code
...
/*************************************************************************************************/
				...
				{
					bool bWantsToEndWar = (GET_TEAM(getTeam()).AI_endWarVal(ePeaceTeam) > (GET_TEAM(ePeaceTeam).AI_endWarVal(getTeam())));
...
/*************************************************************************************************/
	...
	{
		// BBAI TODO: What about Free Religion???
	...
	{
		// BBAI TODO: Spread to last few cities!
			...
			if (iPlayer != getID())
			{
				...
				if (kLoopPlayer.isAlive() && kLoopPlayer.getTeam() != getTeam() && kLoopPlayer.getNumCities() > 0)
				{
					if (GET_TEAM(kLoopPlayer.getTeam()).isOpenBorders(getTeam()))
					{
						...
						// BBAI TODO: No state religion, but running state religion civic???  The AI never does this
